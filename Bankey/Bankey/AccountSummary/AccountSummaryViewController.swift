...
extension AccountSummaryViewController{
    private func fetchData(){
        ...
        let mastercard = AccountSummaryCell.ViewModel(accountType: .CreditCard, accountName: "Student", balance: 50.83)
        let investment1 = AccountSummaryCell.ViewModel(accountType: .Investment, accountName: "Tax free Savings", balance: 2000.00)
        let investment2 = AccountSummaryCell.ViewModel(accountType: .Investment, accountName: "Growth fund", balance: 10000.00)
